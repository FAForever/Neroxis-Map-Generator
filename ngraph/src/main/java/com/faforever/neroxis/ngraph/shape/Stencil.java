...
public class Stencil implements IShape {
    ...
    private static final Logger log = Logger.getLogger(Stencil.class.getName());
    ...
    public void paintShape(Graphics2DCanvas gc, CellState state) {
        ...
        boolean flipH = Utils.isTrue(style, Constants.STYLE_STENCIL_FLIPH, false);
        boolean flipV = Utils.isTrue(style, Constants.STYLE_STENCIL_FLIPV, false);
    ...
    protected void drawElement(GraphicsCanvas2D canvas, CellState state, Element node, Rectangle aspect) {
        ...
        if (name.equals("save")) {
            ...
            double[] curves = Utils.arcToCurves(this.lastMoveX, this.lastMoveY, r1, r2, angle, largeArcFlag, sweepFlag, x, y);
     ...
     */
    public String evaluateAttribute(Element elt, String attribute, CellState state) {
