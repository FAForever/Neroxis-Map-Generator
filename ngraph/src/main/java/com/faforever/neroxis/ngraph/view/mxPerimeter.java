...
public class mxPerimeter {
    ...
    public static mxPerimeterFunction RectanglePerimeter = new mxPerimeterFunction() {
        ...
        /* (non-Javadoc)
         * @see com.faforever.neroxis.ngraph.view.mxPerimeter.mxPerimeterFunction#apply
         */
    ...
    public static mxPerimeterFunction TrianglePerimeter = new mxPerimeterFunction() {
        ...
        /* (non-Javadoc)
         * @see com.faforever.neroxis.ngraph.view.mxPerimeter.mxPerimeterFunction#apply(com.faforever.neroxis.ngraph.utils.mxRectangle, com.faforever.neroxis.ngraph.view.mxCellState, com.faforever.neroxis.ngraph.view.mxCellState, boolean, com.faforever.neroxis.ngraph.utils.mxPoint)
         */
        public mxPoint apply(mxRectangle bounds, mxCellState vertex, mxPoint next, boolean orthogonal) {
            ...
            if (base) {
                ...
                if ((vertical && next.getX() <= x + w / 2) || (!vertical && next.getY() <= y + h / 2)) {
                    result = mxUtils.intersection(next.getX(), next.getY(), cx, cy, start.getX(), start.getY(), corner.getX(), corner.getY());
                } else {
                    result = mxUtils.intersection(next.getX(), next.getY(), cx, cy, corner.getX(), corner.getY(), end.getX(), end.getY());
                }
            }
