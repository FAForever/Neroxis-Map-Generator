...
public class GraphicsCanvas2D implements ICanvas2D {
    ...
    protected String createHtmlDocument(String text, String align, String valign, int w, int h, boolean wrap, String overflow, boolean clip) {
        ...
        css.append("line-height:" + ((Constants.ABSOLUTE_LINE_HEIGHT) ? Math.round(state.fontSize * Constants.LINE_HEIGHT) + " " + HTML_UNIT : Constants.LINE_HEIGHT) + ";");
        ...
        if ((state.fontStyle & Constants.FONT_STRIKETHROUGH) == Constants.FONT_STRIKETHROUGH) {
     ...
     * the shared instance of LighweightLabel.
     */
    ...
    protected void htmlText(double x, double y, double w, double h, String str, String align, String valign, boolean wrap, String format, String overflow, boolean clip, double rotation) {
        ...
        if (textRenderer != null && rendererPane != null) {
            ...
            rendererPane.paintComponent(state.g, textRenderer, rendererPane, (int) Math.round(x / HTML_SCALE), (int) Math.round(y / HTML_SCALE), (int) Math.round(w / HTML_SCALE), (int) Math.round(h / HTML_SCALE), true);
        ...
        if (state.fontColor != null) {
            ...
            for (int i = 0; i < lines.length; i++) {
                ...
                if (!lines[i].isEmpty()) {
                    ...
                    boolean isStrikethrough = (state.fontStyle & Constants.FONT_STRIKETHROUGH) == Constants.FONT_STRIKETHROUGH;
