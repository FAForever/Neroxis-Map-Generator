...
import com.faforever.neroxis.ngraph.swing.view.mxCellStatePreview;
...
public class mxMovePreview extends mxEventSource {
	...
	public void paint(Graphics g) {
		if (placeholder != null) {
			mxSwingConstants.PREVIEW_BORDER.paintBorder(graphComponent, g, placeholder.x, placeholder.y, placeholder.width, placeholder.height);
		}
