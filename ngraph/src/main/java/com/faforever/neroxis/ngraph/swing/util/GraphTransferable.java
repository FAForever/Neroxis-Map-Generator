...
public class GraphTransferable implements Transferable, UIResource, Serializable {
     ...
     * <code>
     * GraphTransferable.dataFlavor = new DataFlavor(DataFlavor.javaJVMLocalObjectMimeType
     * + "; class=com.faforever.neroxis.ngraph.swing.util.GraphTransferable", null,
     * new com.faforever.neroxis.ngraph.swing.util.GraphTransferable(null, null).getClass().getClassLoader());
     * </code>
     */
