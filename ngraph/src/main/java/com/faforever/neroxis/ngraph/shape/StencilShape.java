...
import com.faforever.neroxis.ngraph.util.XmlUtils;
import com.faforever.neroxis.ngraph.util.svg.AWTPathProducer;
import com.faforever.neroxis.ngraph.util.svg.AWTPolygonProducer;
import com.faforever.neroxis.ngraph.util.svg.AWTPolylineProducer;
...
public class StencilShape extends BasicShape {
    ...
    private static final Logger log = Logger.getLogger(StencilShape.class.getName());
