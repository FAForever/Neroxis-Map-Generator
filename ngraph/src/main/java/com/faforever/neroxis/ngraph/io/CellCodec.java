...
public class CellCodec extends ObjectCodec {
     ...
     */
    public CellCodec() {
        this(new Cell(), null, new String[]{"parent", "source", "target"}, null);
    }
    ...
    public boolean isExcluded(Object obj, String attr, Object value, boolean write) {
        return exclude.contains(attr) || (write && attr.equals("value") && value instanceof Node && ((Node) value).getNodeType() == Node.ELEMENT_NODE);
    }
