...
public class CoordinateAssignment implements HierarchicalLayoutStage {
    ...
    public void printStatus() {
        ...
        for (int j = 0; j < model.ranks.size(); j++) {
            ...
            msg.append(j);
            msg.append(" : ");
            GraphHierarchyRank rank = model.ranks.get(j);
     ...
     * @param model an internal model of the hierarchical layout
     */
    protected void calculateWidestRank(Graph graph, GraphHierarchyModel model) {
    ...
    protected void minPath(GraphHierarchyModel model) {
        ...
        Map<ICell, GraphHierarchyEdge> edges = model.getEdgeMapper();
    ...
    protected void setCellLocations(Graph graph, GraphHierarchyModel model) {
        ...
        Map<ICell, GraphHierarchyEdge> edges = model.getEdgeMapper();
        Map<ICell, GraphHierarchyNode> vertices = model.getVertexMapper();
    ...
    protected void localEdgeProcessing(GraphHierarchyModel model) {
        ...
        Map<ICell, GraphHierarchyEdge> edgeMapping = model.getEdgeMapper();
                        ...
                        if (currentRank > -1
                            ...
                            for (int j = 0; j < sortedCells.length; j++) {
                                ...
                                if (innerCell.isVertex()) {
                                    ...
                                    connectedEdgeCount += ((GraphHierarchyEdge) innerCell).edges.size();
                                    connectedEdgeGroupCount++;
    ...
    protected void setEdgePosition(GraphAbstractHierarchyCell cell) {
        ...
        if (edge.temp[0] != 101207) {
            ...
            Iterator<ICell> parallelEdges = edge.edges.iterator();
     ...
     */
    protected void processReversedEdge(GraphHierarchyEdge edge, Object realEdge) {
    ...
    protected class WeightedCellSorter implements Comparable<Object> {
        ...
        public WeightedCellSorter(GraphAbstractHierarchyCell cell, int weightedValue) {
            this.cell = cell;
