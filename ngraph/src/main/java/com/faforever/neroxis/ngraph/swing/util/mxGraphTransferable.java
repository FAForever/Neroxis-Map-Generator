...
public class mxGraphTransferable implements Transferable, UIResource, Serializable {
	 ...
	 * + "; class=com.faforever.neroxis.ngraph.swing.util.mxGraphTransferable");
	 * }
	 ...
	 * <code>
	 * mxGraphTransferable.dataFlavor = new DataFlavor(DataFlavor.javaJVMLocalObjectMimeType
	 * + "; class=com.faforever.neroxis.ngraph.swing.util.mxGraphTransferable", null,
	 * new com.faforever.neroxis.ngraph.swing.util.mxGraphTransferable(null, null).getClass().getClassLoader());
	 * </code>
	 */
	...
	static {
		...
		try {
			dataFlavor = new DataFlavor(DataFlavor.javaSerializedObjectMimeType + "; class=com.faforever.neroxis.ngraph.swing.util.mxGraphTransferable");
		} catch (ClassNotFoundException e) {
