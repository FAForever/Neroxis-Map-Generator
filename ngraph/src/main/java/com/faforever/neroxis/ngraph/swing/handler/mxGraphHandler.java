...
import com.faforever.neroxis.ngraph.swing.util.mxGraphTransferable;
import com.faforever.neroxis.ngraph.swing.util.mxMouseAdapter;
import com.faforever.neroxis.ngraph.swing.util.mxSwingConstants;
import com.faforever.neroxis.ngraph.util.mxCellRenderer;
...
public class mxGraphHandler extends mxMouseAdapter implements DropTargetListener {
	...
	public void updateDragImage(Object[] cells) {
		...
		if (cells != null && cells.length > 0) {
			Image img = mxCellRenderer.createBufferedImage(graphComponent.getGraph(), cells, graphComponent.getGraph().getView().getScale(), null, graphComponent.isAntiAlias(), null, graphComponent.getCanvas());
