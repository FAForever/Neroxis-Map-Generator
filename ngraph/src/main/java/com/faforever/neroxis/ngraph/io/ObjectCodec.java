...
public class ObjectCodec {
    ...
    private static final Logger log = Logger.getLogger(ObjectCodec.class.getName());
     ...
     */
    public ObjectCodec(Object template) {
     ...
     */
    public ObjectCodec(Object template, String[] exclude, String[] idrefs, Map<String, String> mapping) {
     ...
     * <li>Else, if {@link Codec#isEncodeDefaults()} is true or
     ...
     * into the given node using {@link #encodeFields(Codec, Object, Node)}
     * and {@link #encodeElements(Codec, Object, Node)}.
     *
     * @param enc  Codec that controls the encoding process.
     * @param obj  Object to be encoded.
     ...
     * @param node XML node that contains the encoded object.
     */
    protected void encodeFields(Codec enc, Object obj, Node node) {
     ...
     * @param node XML node that contains the encoded object.
     */
    protected void encodeElements(Codec enc, Object obj, Node node) {
     ...
     * {@link #writeAttribute(Codec, Object, String, Object, Node)}
     ...
     * @param node      XML node that contains the encoded object.
     */
    protected void encodeValue(Codec enc, Object obj, String fieldname, Object value, Node node) {
        if (value != null && !isExcluded(obj, fieldname, value, true)) {
            if (isReference(obj, fieldname, value, true)) {
                Object tmp = enc.getId(value);

                if (tmp == null) {
                    log.log(Level.FINEST, "ObjectCodec.encode: No ID for " + getName() + "." + fieldname + "=" + value);
                    return; // exit
                }
     ...
     */
    protected void writeAttribute(Codec enc, Object obj, String attr, Object value, Node node) {
     ...
     */
    protected void writePrimitiveAttribute(Codec enc, Object obj, String attr, Object value, Node node) {
     ...
     */
    protected void writeComplexAttribute(Codec enc, Object obj, String attr, Object value, Node node) {
        ...
        if (child != null) {
            ...
            log.log(Level.FINEST, "ObjectCodec.encode: No node for " + getName() + "." + attr + ": " + value);
        }
    }
     ...
     */
    public Object beforeEncode(Codec enc, Object obj, Node node) {
        return obj;
    }
     ...
     */
    public Object decode(Codec dec, Node node) {
     ...
     */
    protected void decodeNode(Codec dec, Node node, Object obj) {
        if (node != null) {
     ...
     */
    protected void decodeAttributes(Codec dec, Node node, Object obj) {
     ...
     */
    protected void decodeAttribute(Codec dec, Node attr, Object obj) {
        ...
        if (!name.equalsIgnoreCase("as") && !name.equalsIgnoreCase("id")) {
            ...
            if (isReference(obj, fieldname, value, false)) {
                ...
                if (tmp == null) {
                    log.log(Level.FINEST, "ObjectCodec.decode: No object for " + getName() + "." + fieldname + "=" + value);
                    return; // exit
                }
     ...
     */
    protected void decodeChildren(Codec dec, Node node, Object obj) {
     ...
     */
    protected void decodeChild(Codec dec, Node child, Object obj) {
     ...
     */
    public boolean processInclude(Codec dec, Node node, Object into) {
