...
public class Constants {
     ...
     * The value is a string expression supported by Utils.parseColor.
     *
     * @see Utils#parseColor(String)
     */
     ...
     * 1(enabled). The default value is 0. This is used in Label.
     */
    public static String STYLE_GLASS = "glass";
    /**
     * Defines the key for the image style. Possible values are any image URL,
     * registered key in ImageResources or short data URI as defined in
     * ImageBundle.
     ...
     * supported in the <code>Connector</code> shape.
     */
     ...
     * See STYLE_ENDARROW.
     * This style is supported in the Connector shape.
     */
     ...
     * (default) for fill. (This style is only exported via <ImageExport>.)
     */
     ...
     * (This style is only exported via <ImageExport>.) Value is "arcSize".
     */
     ...
     * specify the direction of certain shapes (eg. <code>Triangle</code>).
