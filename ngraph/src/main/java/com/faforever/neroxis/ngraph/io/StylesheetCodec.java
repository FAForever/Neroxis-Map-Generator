...
import com.faforever.neroxis.ngraph.view.Stylesheet;
...
/**
 * Codec for Stylesheets. This class is created and registered
...
public class StylesheetCodec extends ObjectCodec {
     ...
     */
    public StylesheetCodec(Object template, String[] exclude, String[] idrefs, Map<String, String> mapping) {
            ...
            while (node != null) {
                if (!processInclude(dec, node, obj) && node.getNodeName().equals("add") && node instanceof Element) {
                    ...
                    if (as != null && as.length() > 0) {
                        ...
                        Map<String, Object> style = (extend != null) ? ((Stylesheet) obj).getStyles().get(extend) : null;
