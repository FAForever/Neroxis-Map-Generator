...
import com.faforever.neroxis.ngraph.canvas.mxICanvas;
import com.faforever.neroxis.ngraph.model.mxGraphModel;
import com.faforever.neroxis.ngraph.model.mxGraphModel.Filter;
import com.faforever.neroxis.ngraph.model.mxIGraphModel;
import com.faforever.neroxis.ngraph.swing.handler.mxCellHandler;
import com.faforever.neroxis.ngraph.swing.handler.mxConnectionHandler;
import com.faforever.neroxis.ngraph.swing.handler.mxEdgeHandler;
import com.faforever.neroxis.ngraph.swing.handler.mxElbowEdgeHandler;
import com.faforever.neroxis.ngraph.swing.handler.mxGraphHandler;
import com.faforever.neroxis.ngraph.swing.handler.mxGraphTransferHandler;
import com.faforever.neroxis.ngraph.swing.handler.mxPanningHandler;
import com.faforever.neroxis.ngraph.swing.handler.mxSelectionCellsHandler;
import com.faforever.neroxis.ngraph.swing.handler.mxVertexHandler;
import com.faforever.neroxis.ngraph.swing.util.mxCellOverlay;
import com.faforever.neroxis.ngraph.swing.util.mxICellOverlay;
import com.faforever.neroxis.ngraph.swing.view.mxCellEditor;
import com.faforever.neroxis.ngraph.swing.view.mxICellEditor;
import com.faforever.neroxis.ngraph.swing.view.mxInteractiveCanvas;
...
import com.faforever.neroxis.ngraph.util.mxEventSource.mxIEventListener;
import com.faforever.neroxis.ngraph.util.mxPoint;
import com.faforever.neroxis.ngraph.util.mxRectangle;
import com.faforever.neroxis.ngraph.util.mxResources;
import com.faforever.neroxis.ngraph.util.mxUtils;
import com.faforever.neroxis.ngraph.view.mxCellState;
import com.faforever.neroxis.ngraph.view.mxEdgeStyle;
import com.faforever.neroxis.ngraph.view.mxEdgeStyle.mxEdgeStyleFunction;
import com.faforever.neroxis.ngraph.view.mxGraph;
import com.faforever.neroxis.ngraph.view.mxGraphView;
import com.faforever.neroxis.ngraph.view.mxTemporaryCellStates;
...
public class mxGraphComponent extends JScrollPane implements Printable {
     ...
     */
    static {
        DEFAULT_EXPANDED_ICON = new ImageIcon(mxGraphComponent.class.getResource("/images/expanded.gif"));
        DEFAULT_COLLAPSED_ICON = new ImageIcon(mxGraphComponent.class.getResource("/images/collapsed.gif"));
        DEFAULT_WARNING_ICON = new ImageIcon(mxGraphComponent.class.getResource("/images/warning.gif"));
    }
    ...
    public boolean isToggleEvent(MouseEvent event) {
        ...
        return event != null && ((mxUtils.IS_MAC) ? ((SwingUtilities.isLeftMouseButton(event) && event.isMetaDown()) || (SwingUtilities.isRightMouseButton(event) && event.isControlDown())) : event.isControlDown());
    }
     ...
     * @see com.faforever.neroxis.ngraph.util.mxEventSource#isEventsEnabled()
     */
    ...
    /**
     * @param eventsEnabled
     * @see com.faforever.neroxis.ngraph.util.mxEventSource#setEventsEnabled(boolean)
     */
     ...
     * @param eventName
     * @param listener
     * @see com.faforever.neroxis.ngraph.util.mxEventSource#addListener(java.lang.String,
     * com.faforever.neroxis.ngraph.util.mxEventSource.mxIEventListener)
     */
