...
import com.faforever.neroxis.ngraph.model.mxCellPath;
...
public class mxParallelEdgeLayout extends mxGraphLayout {
	...
	/*
	 * (non-Javadoc)
	 * @see com.faforever.neroxis.ngraph.layout.mxIGraphLayout#execute(java.lang.Object)
	 */
	...
	protected void route(Object edge, double x, double y) {
		if (graph.isCellMovable(edge)) {
			setEdgePoints(edge, Arrays.asList(new mxPoint(x, y)));
		}
	}
