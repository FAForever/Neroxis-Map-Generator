...
import com.faforever.neroxis.ngraph.canvas.mxImageCanvas;
import com.faforever.neroxis.ngraph.model.mxCell;
import com.faforever.neroxis.ngraph.model.mxGeometry;
import com.faforever.neroxis.ngraph.model.mxGraphModel;
import com.faforever.neroxis.ngraph.model.mxGraphModel.Filter;
import com.faforever.neroxis.ngraph.model.mxGraphModel.mxChildChange;
import com.faforever.neroxis.ngraph.model.mxGraphModel.mxCollapseChange;
import com.faforever.neroxis.ngraph.model.mxGraphModel.mxGeometryChange;
import com.faforever.neroxis.ngraph.model.mxGraphModel.mxRootChange;
import com.faforever.neroxis.ngraph.model.mxGraphModel.mxStyleChange;
import com.faforever.neroxis.ngraph.model.mxGraphModel.mxTerminalChange;
import com.faforever.neroxis.ngraph.model.mxGraphModel.mxValueChange;
import com.faforever.neroxis.ngraph.model.mxGraphModel.mxVisibleChange;
...
import com.faforever.neroxis.ngraph.util.mxImageBundle;
...
import com.faforever.neroxis.ngraph.util.mxStyleUtils;
import com.faforever.neroxis.ngraph.util.mxUndoableEdit;
import com.faforever.neroxis.ngraph.util.mxUndoableEdit.mxUndoableChange;
...
public class mxGraph extends mxEventSource {
	...
	protected mxIEventListener graphModelChangeHandler = new mxIEventListener() {
		public void invoke(Object sender, mxEventObject evt) {
			mxRectangle dirty = graphModelChanged((mxIGraphModel) sender, ((mxUndoableEdit) evt.getProperty("edit")).getChanges());
			repaint(dirty);
		}
	};
	 ...
	 * {@link com.faforever.neroxis.ngraph.model.mxGraphModel}.
	 */
	public mxGraph() {
		this(null, null);
	}
	 ...
	 * specified, then a new, empty {@link com.faforever.neroxis.ngraph.model.mxGraphModel} is
	 * used.
	 *
	...
	public boolean isLabelClipped(Object cell) {
		if (!isLabelsClipped()) {
			...
			return style != null && mxUtils.getString(style, mxConstants.STYLE_OVERFLOW, "").equals("hidden");
		}
