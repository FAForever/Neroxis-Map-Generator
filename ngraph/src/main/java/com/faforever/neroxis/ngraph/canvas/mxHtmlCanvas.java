...
public class mxHtmlCanvas extends mxBasicCanvas {
	...
	public Element drawShape(int x, int y, int w, int h, Map<String, Object> style) {
		...
		if (mxUtils.isTrue(style, mxConstants.STYLE_SHADOW, false) && fillColor != null) {
			...
			String s = "overflow:hidden;position:absolute;" + "left:" + (x + mxConstants.SHADOW_OFFSETX) + "px;" + "top:" + (y + mxConstants.SHADOW_OFFSETY) + "px;" + "width:" + w + "px;" + "height:" + h + "px;background:" + mxConstants.W3C_SHADOWCOLOR + ";border-style:solid;border-color:" + mxConstants.W3C_SHADOWCOLOR + ";border-width:" + Math.round(strokeWidth) + ";";
