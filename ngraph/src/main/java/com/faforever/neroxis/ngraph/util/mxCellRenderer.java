...
import com.faforever.neroxis.ngraph.canvas.mxHtmlCanvas;
import com.faforever.neroxis.ngraph.canvas.mxICanvas;
import com.faforever.neroxis.ngraph.canvas.mxImageCanvas;
import com.faforever.neroxis.ngraph.canvas.mxSvgCanvas;
import com.faforever.neroxis.ngraph.canvas.mxVmlCanvas;
...
public class mxCellRenderer {
	 ...
	 *
	 */
	public static BufferedImage createBufferedImage(mxGraph graph, Object[] cells, double scale, final Color background, final boolean antiAlias, mxRectangle clip, final mxGraphics2DCanvas graphicsCanvas) {
