        ...
        fractalParams = FractalParams.builder()
                                     ...
                                     .fractalFlattenParams(List.of(
                                             ...
                                             FractalFlattenParams.builder()
                                                                 .minHeight(4.0f)
                                                                 .maxHeight(6.0f)
                                                                 .destinationMinHeight(13.0f)
                                                                 .destinationMaxHeight(13.0f)
                                                                 .slope(0.0f)
                                                                 .edgeBlur(2)
                                                                 .hasRamps(false)
                                                                 .rampPercentage(0.0f)
                                             ...
                                             FractalFlattenParams.builder()
                                                                 .minHeight(6.0f)
                                                                 .maxHeight(15.0f)
                                                                 .destinationMinHeight(11.0f)
                                                                 .destinationMaxHeight(11.0f)
                                                                 .slope(0.0f)
                                                                 .edgeBlur(0)
                                                                 .hasRamps(false)
                                                                 .rampPercentage(0.0f)
