...
public class BasicOptions {
    ...
    @CommandLine.Option(
            ...
            order = 5,
            defaultValue = "6",
            description = "Spawn count for the generated map",
    ...
    @CommandLine.Option(
            ...
            order = 6,
            defaultValue = "2",
            description = "Number of teams for the generated map (0 is no teams asymmetric)",
            showDefaultValue = CommandLine.Help.Visibility.ALWAYS
    )
    ...
    @CommandLine.Option(
            ...
            order = 4,
            defaultValue = "512",
            description = "Generated map size, can be specified in oGrids (e.g 512) or km (e.g 10km)",
            showDefaultValue = CommandLine.Help.Visibility.ALWAYS,
            converter = MultipleMapSizeConverter.class
    )
