...
public class BasicOptions {
    ...
    @CommandLine.Option(names = "--num-teams", order = 4, defaultValue = "2", description = "Number of teams for the generated map (0 is no teams asymmetric)", showDefaultValue = CommandLine.Help.Visibility.ALWAYS)
    private Integer numTeams;
    private Integer mapSize;

    @CommandLine.Option(names = "--map-size", order = 2, defaultValue = "512", description = "Generated map size, can be specified in oGrids (e.g 512) or km (e.g 10km)", showDefaultValue = CommandLine.Help.Visibility.ALWAYS)
