...
public class BasicOptions {
    ...
    @CommandLine.Option(names = "--spawn-count", order = 5, defaultValue = "8", description = "Spawn count for the generated map", showDefaultValue = CommandLine.Help.Visibility.ALWAYS)
