...
public class OneIslandTerrainGenerator extends PathedTerrainGenerator {
    ...
    protected void teamConnectionsSetup() {
        ...
        MapMaskMethods.connectLocationsThroughMiddle(team0Spawns, random.nextLong(), connections, minMiddlePoints,
                                                     maxMiddlePoints,
    ...
    protected void landSetup() {
        ...
        MapMaskMethods.connectLocationsAroundCenter(team0Spawns, random.nextLong(), land, minMiddlePoints,
                                                    maxMiddlePoints,
