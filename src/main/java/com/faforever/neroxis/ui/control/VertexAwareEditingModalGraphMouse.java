 ...
 */
@Slf4j
public class VertexAwareEditingModalGraphMouse<V, E> extends DefaultModalGraphMouse<V, E>
    ...
    public static class Builder<
            V, E, T extends VertexAwareEditingModalGraphMouse<V, E>, B extends Builder<V, E, T, B>>
        ...
        public B edgeFactory(BiFunction<V, V, E> edgeFactory) {
        ...
        public T build() {
            return (T) new VertexAwareEditingModalGraphMouse<>(this);
        }
    }
    ...
    protected VertexAwareEditingMousePlugin<V, E> editingPlugin;
    protected LabelEditingGraphMousePlugin<V, E> labelEditingPlugin;
    protected VertexAwarePopupMousePlugin<V, E> popupEditingPlugin;
    protected AnnotatingGraphMousePlugin<V, E> annotatingPlugin;
    protected MultiLayerTransformer basicTransformer;
    protected RenderContext<V, E> rc;

    public VertexAwareEditingModalGraphMouse(Builder<V, E, ?, ?> builder) {
        super(builder);
    ...
    public void loadPlugins() {
        ...
        editingPlugin = VertexAwareEditingMousePlugin.builder(vertexFactory, edgeFactory).build();
        ...
        popupEditingPlugin = new VertexAwarePopupMousePlugin<>(vertexFactory, edgeFactory);
        setMode(this.mode);
    }
     ...
     */
    public VertexAwareEditingMousePlugin<V, E> getEditingPlugin() {
     ...
     */
    public VertexAwarePopupMousePlugin<V, E> getPopupEditingPlugin() {
