 ...
 * @author Tom Nelson
 */
public class VertexAwarePopupMousePlugin<V, E> extends AbstractPopupGraphMousePlugin {

    protected Supplier<V> vertexFactory;
    protected BiFunction<V, V, E> edgeFactory;

    public VertexAwarePopupMousePlugin(Supplier<V> vertexFactory, BiFunction<V, V, E> edgeFactory) {
                        ...
                        menu.add(
                                new AbstractAction("[" + other + "," + vertex + "]") {
                                    public void actionPerformed(ActionEvent e) {
                                        graph.addEdge(other, vertex, edgeFactory.apply(other, vertex));
                                        vv.repaint();
                                    }
                                });
                    }
