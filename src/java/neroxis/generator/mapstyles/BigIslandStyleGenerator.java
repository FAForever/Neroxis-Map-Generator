...
public strictfp class BigIslandStyleGenerator extends BaseStyleGenerator {

    private final float mountainDensityMin = 0f;
    private final float mountainDensityMax = 1f;
    private final float mountainDensityRange = mountainDensityMax - mountainDensityMin;
